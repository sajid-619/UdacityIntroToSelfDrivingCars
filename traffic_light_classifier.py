...
def pixel_count (rgb_image):
    summed = rgb_image.sum(axis=2)
    alt_count = np.count_nonzero(summed)
    return alt_count


# ## (QUESTION 1): How do the features you made help you distinguish between the 3 classes of traffic light images?

# **Answer**: Decided to use RGB filter and brightness. The hue value comes from online color pickers and I am calculating the average saturation and brightness increasing the saturation threshhold %, experimentally.
